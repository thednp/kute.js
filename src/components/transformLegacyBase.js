  ...
  if (!KEC[tweenProp] && this.valuesEnd[tweenProp]) {
    if (support3DTransform) {
      KEC[tweenProp] = (elem, a, b, v) => {
        ...
        elem.style[transformProperty] = (a.perspective || b.perspective
          ? perspective(a.perspective, b.perspective, "px", v)
          : "") + // one side might be 0
          (a.translate3d
            ? translate3d(a.translate3d, b.translate3d, "px", v)
            : "") + // array [x,y,z]
      ...
      KEC[tweenProp] = (elem, a, b, v) => {
        ...
        elem.style[transformProperty] =
          ...
          ((a.rotate || b.rotate)
            ? rotate(a.rotate, b.rotate, "deg", v)
            : "") + // one side might be 0
          (a.skew ? skew(a.skew, b.skew, "deg", v) : "") + // array [x,y]
          (a.scale || b.scale ? scale(a.scale, b.scale, v) : ""); // one side might be 0
      };
